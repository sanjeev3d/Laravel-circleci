...
return [
    ...
    'routes' => [
        ...
        [
             ...
             */
            'exclude' => [
                'oauth/*','api/authenticate/login','api/authenticate/register','login','logout','register','password/reset',
                'password/email','password/reset/{token}'
                // 'users.create', 'admin.*'
            ],
     ...
     */
    'default_group' => 'Register or Login',
